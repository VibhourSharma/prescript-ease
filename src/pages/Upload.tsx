  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Upload your medical prescription for instant decoding and detailed analysis."
        />
        <meta name="robots" content="noindex, follow" />{" "}
        {/* Don't index upload page */}
            ...
            <div className="max-w-3xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                  We support JPG, PNG, and PDF formats. Your data is secure and
                  encrypted.
                </p>
              </div>
              ...
              <div className="mt-12 p-4 border border-border rounded-lg bg-secondary/30">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Your prescription data is protected with the highest level of
                  security:
                </p>
